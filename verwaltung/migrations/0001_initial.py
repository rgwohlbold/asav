# Generated by Django 2.2 on 2019-10-23 17:22
...
class Migration(migrations.Migration):
    ...
    replaces = [('verwaltung', '0001_initial')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aktivitaetsergebnis', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='verwaltung.AktivitaetErgebnis', verbose_name='Aktivitätsergebnis')),
        ...
        migrations.AddField(
            model_name='aktivitaet',
            name='moegliche_ergebnisse',
            field=models.ManyToManyField(through='verwaltung.AktivitaetErgebnis', to='verwaltung.Ergebnis'),
        ),
    ]
